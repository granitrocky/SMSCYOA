...
ACCOUNT = 'fountainheadgame@gmail.com' # Set to Google Voice account email for default account
PASSWORD = 'fountain2088' # Set to Google Voice account password for default account
NUMBERS = ['6125457145'] # Set one or more numbers for default destination(s)
